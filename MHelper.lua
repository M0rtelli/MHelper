...
sampRegisterChatCommand('az', function()
		...
		requestCollision(2570,-1281)
		loadScene(2570,-1281,1065)
		activateInteriorPeds(true)
		teleport(2570,-1281,1065)
...
style()		
			if not test8.v or not povs.v or not cheats.v or not help.v or not main_window_state.v or not lvla.v or not gps1.v or not gps2.v or not gps3.v or not gps4.v or not gps5.v or not gps6.v or not gps7.v or not gps8.v or not sec_window_state.v or not main_menu.v or not slave.v then
			imgui.Process = false
end
...
if imgui.CustomButton(u8'Назад', imgui.ImVec4(0.0,0.0,0.0,1.0), imgui.ImVec4(1.0,0.0,0.0,1.0), imgui.ImVec4(1.0,0.0,0.0,1.0), imgui.ImVec2(130, 25)) then
 ...
 imgui.End()
			...
			if povs.v then
				...
				sampAddChatMessage('/spawn ' .. f66, -1)
				wait(2000)
			 ...
			 style2()
				...
				imgui.SetNextWindowPos(imgui.ImVec2(h1 / 1.2, h2 / 2.7), imgui.ImVec2(0.5, 0.5))
